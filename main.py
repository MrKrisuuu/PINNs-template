...
if __name__ == "__main__":
    ...
    plot_1D(best_pinn_SIR, t, title="SIR model", save="SIR_pinn_result", labels=["S", "I", "R"], ylabel="Population")
    ...
    print_loss(loss_Heat, best_pinn_Heat)
    ...
    t.requires_grad = True
    plot_3D(best_pinn_Heat, x, y, t, name="Heat_pinn_result")
